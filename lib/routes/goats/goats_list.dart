...
class GoatsList extends StatelessWidget {
  GoatsList({Key? key}) : super(key: key){
    controller.getMales("male_goats");
    controller.getFemales("female_goats");
  }
          ...
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) {
                  return Females("female_goats", false);
                }));
              },
            ),
          ),
